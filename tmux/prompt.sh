...
set -g message-style bg="colour103"
set -g status-right-length "100"
set -g status-right attr="none"
set -g message-style fg="colour236"
set -g message-command-style bg="colour103"
set -g pane-border-style fg="colour239"
set -g status-left attr="none"
setw -g window-status-style fg="colour103"
setw -g window-status-activity-style bg="colour236"
setw -g window-status-activity-style fg="colour103"
